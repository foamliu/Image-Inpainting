...
from keras.layers import UpSampling2D, Conv2D, BatchNormalization
...
def build_model():
    ...
    x = Conv2D(256, (kernel, kernel), activation='elu', padding='same', name='deconv4_1',
               kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
    x = Conv2D(256, (kernel, kernel), activation='elu', padding='same', name='deconv4_2',
               kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
    ...
    x = UpSampling2D(size=(2, 2))(x)
    x = Conv2D(128, (kernel, kernel), activation='elu', padding='same', name='deconv3_1',
               kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
    x = Conv2D(128, (kernel, kernel), activation='elu', padding='same', name='deconv3_2',
               kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
    ...
    x = UpSampling2D(size=(2, 2))(x)
    x = Conv2D(64, (kernel, kernel), activation='elu', padding='same', name='deconv2_1',
               kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
